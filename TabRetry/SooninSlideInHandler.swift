...
class SooninSlideInHandler: NSObject , UICollectionViewDelegate , UICollectionViewDataSource , UICollectionViewDelegateFlowLayout {
    ...
    func slideMenuLocationCalculator(window: UIView) -> MenuLocation {
        ...
        let menuWidth:CGFloat = menuCellWidth
        
        switch MainMenuSide {
        case .TOP :
            menuLocation.width = window.frame.width
            menuLocation.height = menuHeight
            menuLocation.xTo = 0
            menuLocation.yTo = 0
            menuLocation.xFrom = 0
            menuLocation.yFrom = 0 - menuHeight
        case .Right :
            menuLocation.width = menuWidth
        ...
        case .Left :
            ...
            menuLocation.xTo = 0
            menuLocation.yTo = 0
            menuLocation.xFrom = 0 - menuWidth
            menuLocation.yFrom = 0
        case .Bottom :
            menuLocation.width = window.frame.width
            menuLocation.height = menuHeight
...
class SettingCell: BaseCell {
    ...
    override func setupViews() {
        ...
        backgroundColor =  localslideInHandler.menuCellsBackColor
